...
class S900_Seo_Block_Layer_View extends Mage_Core_Block_Template
{
	protected function _initBlocks()
    {
        $this->_stateBlockName              = 'catalog/layer_state';

        $this->_categoryBlockName           = 's900_seo/layer_filter_category';
        $this->_attributeFilterBlockName    = 's900_seo/layer_filter_attribute';
